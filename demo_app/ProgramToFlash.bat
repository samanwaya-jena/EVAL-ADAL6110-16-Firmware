...
REM "%CCESDir%\cldp.exe" -config %configFile% -emu 1000 -driver "%DriverPath%" -cmd prog -erase affected -format hex -file %Configuration%\%TargetName%%TargetExt% -verbose -log
